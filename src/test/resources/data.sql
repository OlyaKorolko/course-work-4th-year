...
insert into cinema (name, address, city, email, phone)
values ('Test', 'Test address', 'Minsk', 'test@test', '+000000000');
...
insert into users (first_name, last_name, user_name, email, phone, password, registration_date_time, category_id, role)
values ('A', 'B', 'AD', 'a@a', '4364364354', 'jfd2394ucf923urhcf', '2022-01-08T12:30:00', 1, 1);
